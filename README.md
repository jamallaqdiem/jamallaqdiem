# Hi, I'm Jamal Laqdiem 

### Junior Software Developer | Healthcare Management Background
I build practical, real-world solutions with a focus on security and efficiency. Currently transitioning from a career in healthcare management to software engineering, bringing a meticulous eye for detail and data integrity.
...
* **Frontend:** React and Tailwind CSS for a dynamic dashboard.
* **Cloud:** Deployment and environment management within the **Azure Cloud** ecosystem.
...
#### Frontend & Desktop
* JavaScript | React | Electron | TailwindCSS

#### Backend & Cloud
* NodeJS | Azure Cloud | Microsoft SQL | SQLite3
